...
curl -d "address=1/78-80 Commercial Road, Prahran, Vic 3181&price=700000&suburb=Parahran&description=Auction" -X POST http://localhost:3000/
...
curl -d "address=1 Williams Road, Prahran, Vic 3181&price=4000000&suburb=Parahran&description=Auction" -X POST http://localhost:3000/
...
# get the properties in Parahran
curl --request GET http://localhost:3000/?suburb=Parahran | json_pp
